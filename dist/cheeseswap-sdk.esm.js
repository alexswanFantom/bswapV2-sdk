...
var Token$1 = /*#__PURE__*/function (_Currency) {
...
function currencyEquals$1(currencyA, currencyB) {
  if (currencyA instanceof Token$1 && currencyB instanceof Token$1) {
    return currencyA.equals(currencyB);
  } else if (currencyA instanceof Token$1) {
    return false;
  } else if (currencyB instanceof Token$1) {
    return false;
  } else {
    return currencyA === currencyB;
  }
}
var WETH$1 = (_WETH$1 = {}, _WETH$1[ChainId.MAINNET] = /*#__PURE__*/new Token$1(ChainId.MAINNET, '0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101', 18, 'WWDOGE', 'Wrapped WDOGE'), _WETH$1[ChainId.BSCTESTNET] = /*#__PURE__*/new Token$1(ChainId.BSCTESTNET, '0xaE8E19eFB41e7b96815649A6a60785e1fbA84C1e', 18, 'WBNB', 'Wrapped BNB'), _WETH$1);
...
ETHER.Instance = /*#__PURE__*/new ETHER(18, "WDOGE", "Wrapped Dogecoin");
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.ether = function ether(amount) {
    return new CurrencyAmount(ETHER.Instance, amount);
  };

  var _proto = CurrencyAmount.prototype;

  _proto.add = function add(other) {
    !currencyEquals$1(this.currency, other.currency) ? process.env.NODE_ENV !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.multiply = function multiply(other) {
    !currencyEquals$1(this.quoteCurrency, other.baseCurrency) ? process.env.NODE_ENV !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
  ...
  _proto.quote = function quote(currencyAmount) {
    !currencyEquals$1(currencyAmount.currency, this.baseCurrency) ? process.env.NODE_ENV !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;

    if (this.quoteCurrency instanceof Token$1) {
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token$1(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'BLP-V2', 'Bswap LPs');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token$1 && pairs[0].involvesToken(input) || input === ETHER.Instance && pairs[0].involvesToken(WETH$1[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token$1 && pairs[pairs.length - 1].involvesToken(output) || output === ETHER.Instance && pairs[pairs.length - 1].involvesToken(WETH$1[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token$1 ? input : WETH$1[pairs[0].chainId]];
...
function inputOutputComparator(a, b) {
  ...
  !currencyEquals$1(a.inputAmount.currency, b.inputAmount.currency) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT_CURRENCY') : invariant(false) : void 0;
  !currencyEquals$1(a.outputAmount.currency, b.outputAmount.currency) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT_CURRENCY') : invariant(false) : void 0;
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === ETHER.Instance) return new TokenAmount(WETH$1[chainId], currencyAmount.raw);
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token$1) return currency;
  if (currency === ETHER.Instance) return WETH$1[chainId];
   process.env.NODE_ENV !== "production" ? invariant(false, 'CURRENCY') : invariant(false) ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    if (tradeType === TradeType.EXACT_INPUT) {
      !currencyEquals$1(amount.currency, route.input) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
      ...
      !currencyEquals$1(amount.currency, route.output) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === ETHER.Instance ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === ETHER.Instance ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    var chainId = currencyAmountIn instanceof TokenAmount ? currencyAmountIn.token.chainId : currencyOut instanceof Token$1 ? currencyOut.chainId : undefined;
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    var chainId = currencyAmountOut instanceof TokenAmount ? currencyAmountOut.token.chainId : currencyIn instanceof Token$1 ? currencyIn.chainId : undefined;
    !(chainId !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'CHAIN_ID') : invariant(false) : void 0;
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === ETHER.Instance;
    var etherOut = trade.outputAmount.currency === ETHER.Instance; // the router does not support both ether in and out
...
export { ChainId, CurrencyAmount, ETHER, FACTORY_ADDRESS, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
