...
var WETH$1 = (_WETH$1 = {}, _WETH$1[exports.ChainId.MAINNET] = /*#__PURE__*/new Token$1(exports.ChainId.MAINNET, '0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101', 18, 'WWDOGE', 'Wrapped WDOGE'), _WETH$1[exports.ChainId.BSCTESTNET] = /*#__PURE__*/new Token$1(exports.ChainId.BSCTESTNET, '0xaE8E19eFB41e7b96815649A6a60785e1fbA84C1e', 18, 'WBNB', 'Wrapped BNB'), _WETH$1);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.add = function add(other) {
    !currencyEquals$1(this.currency, other.currency) ?  invariant(false, 'TOKEN')  : void 0;
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.multiply = function multiply(other) {
    !currencyEquals$1(this.quoteCurrency, other.baseCurrency) ?  invariant(false, 'TOKEN')  : void 0;
  ...
  _proto.quote = function quote(currencyAmount) {
    !currencyEquals$1(currencyAmount.currency, this.baseCurrency) ?  invariant(false, 'TOKEN')  : void 0;
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token$1 && pairs[0].involvesToken(input) || input === ETHER.Instance && pairs[0].involvesToken(WETH$1[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token$1 && pairs[pairs.length - 1].involvesToken(output) || output === ETHER.Instance && pairs[pairs.length - 1].involvesToken(WETH$1[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
function inputOutputComparator(a, b) {
  ...
  !currencyEquals$1(a.inputAmount.currency, b.inputAmount.currency) ?  invariant(false, 'INPUT_CURRENCY')  : void 0;
  !currencyEquals$1(a.outputAmount.currency, b.outputAmount.currency) ?  invariant(false, 'OUTPUT_CURRENCY')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    if (tradeType === exports.TradeType.EXACT_INPUT) {
      !currencyEquals$1(amount.currency, route.input) ?  invariant(false, 'INPUT')  : void 0;
      ...
      !currencyEquals$1(amount.currency, route.output) ?  invariant(false, 'OUTPUT')  : void 0;
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER.Instance ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER.Instance ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
